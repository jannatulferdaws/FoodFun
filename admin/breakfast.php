...
<body>
	...
	<div class="menu-box">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Breakfast</h2>
						<p>Breakfast is the first meal of the day eaten after waking up, usually in the morning.<br>
						It is commonly referred to as "the most important meal of the day".<br>
						Let's take a look of FoodFun Breakfast.</p><br>
				...
				<div class="col-lg-6">
					<div class="special-menu text-right">
						<div class="button-group filter-button-group">
							<button class="active" data-filter="*"><a href="breakfast.php" class="text-white text-bold">All</a></button>
				...
				<div class="col-lg-5">
					<div class="special-menu ">
						<div class="button-group filter-button-group">
							...
							<form class="" action="breakfast.php" method="post">
				...
				if(isset($_POST['search']))
        {
          ...
          $display=" select * from product where Catagory_Name='Breakfast' and Product_Name  like '%$searchkey%'";
        }

				else if(isset($_POST['offer']))
				{
					$display=" select * from product where Catagory_Name='Breakfast' and discount!='0'";
				}

				else{
					$display=" select * from product where Catagory_Name='Breakfast' ";
				}
			...
			<div class="center">
					<button class="food-btn"><a href="comment.php">Feedback</a></button>
				</div>
		</div>
