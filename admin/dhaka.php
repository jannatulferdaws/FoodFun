...
<body>
	...
	<div class="menu-box">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Dhaka</h2>
						<p>Dhaka is the capital city of Bangladesh<br>
						Let's see our Dhakaiya Dishes.</p><br>

						<form action="dhaka.php" method="post" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
				...
				<div class="col-lg-6">
					<div class="special-menu text-right">
						<div class="button-group filter-button-group">
							<button class="active" data-filter="*"><a href="dhaka.php" class="text-white text-bold">All</a></button>
				...
				<div class="col-lg-5">
					<div class="special-menu ">
						<div class="button-group filter-button-group">
							...
							<form class="" action="dhaka.php" method="post">
				...
				if(isset($_POST['search']))
        {
          ...
          $display=" select * from product where Catagory_Name='Dhaka' and Product_Name  like '%$searchkey%'";
        }

				else if(isset($_POST['offer']))
				{
					$display=" select * from product where Catagory_Name='Dhaka' and discount!='0'";
				}

				else{
					$display=" select * from product where Catagory_Name='Dhaka' ";
				}
			...
			<div class="center">
					<button class="food-btn"><a href="dhakaComment.php">Feedback</a></button>
				</div>
		</div>
