...
<body>
	...
	<div class="menu-box">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Dinner</h2>
						<p>In many modern usages, the term dinner refers to the evening meal, which is now typically the largest meal of the day in Western cultures. When this meaning is used, the preceding meals are usually referred to as breakfast, lunch and perhaps a tea.[2][12] Supper is now often an alternative term for dinner; originally this was always a later secondary evening meal, after an early dinner.<br>
						Let's take a look of FoodFun Dinner Combo.</p><br>
						<form action="dinner.php" method="post" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
				...
				<div class="col-lg-6">
					<div class="special-menu text-right">
						<div class="button-group filter-button-group">
							<button class="active" data-filter="*"><a href="dinner.php" class="text-white text-bold">All</a></button>
				...
				<div class="col-lg-5">
					<div class="special-menu ">
						<div class="button-group filter-button-group">
							...
							<form class="" action="dinner.php" method="post">
				...
				if(isset($_POST['search']))
        {
          ...
          $display=" select * from product where Catagory_Name='Dinner' and Product_Name  like '%$searchkey%'";
        }

				else if(isset($_POST['offer']))
				{
					$display=" select * from product where Catagory_Name='Dinner' and discount!='0'";
				}

				else{
					$display=" select * from product where Catagory_Name='Dinner' ";
				}
			...
			<div class="center">
					<button class="food-btn"><a href="dinnerComment.php">Feedback</a></button>
				</div>
		</div>
