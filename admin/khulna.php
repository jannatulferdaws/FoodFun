...
<body>
	...
	<div class="menu-box">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Khulna</h2>
						<p>Khulna , where our largest mangrove forest "Sundarbans is situated.<br>
						Let's see our Khulna Dishes.</p><br>

						<form action="khulna.php" method="post" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
				...
				<div class="col-lg-6">
					<div class="special-menu text-right">
						<div class="button-group filter-button-group">
							<button class="active" data-filter="*"><a href="khulna.php" class="text-white text-bold">All</a></button>
				...
				<div class="col-lg-5">
					<div class="special-menu ">
						<div class="button-group filter-button-group">
							...
							<form class="" action="khulna.php" method="post">
				...
				if(isset($_POST['search']))
        {
          ...
          $display=" select * from product where Catagory_Name='Khulna' and Product_Name  like '%$searchkey%'";
        }

				else if(isset($_POST['offer']))
				{
					$display=" select * from product where Catagory_Name='Khulna' and discount!='0'";
				}

				else{
					$display=" select * from product where Catagory_Name='Khulna' ";
				}
			...
			<div class="center">
					<button class="food-btn"><a href="khulnaComment.php">Feedback</a></button>
				</div>
		</div>
