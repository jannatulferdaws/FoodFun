...
<body>
	...
	<div class="menu-box">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Lunch</h2>
						<p>Lunch is the second meal of the day eaten after waking up, usually in the afternoon.<br>
						It is commonly referred to as "the most important meal of the day".<br>
						Let's take a look of FoodFun Lunch.</p><br>

						<form action="lunch.php" method="post" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
				...
				<div class="col-lg-6">
					<div class="special-menu text-right">
						<div class="button-group filter-button-group">
							<button class="active" data-filter="*"><a href="lunch.php" class="text-white text-bold">All</a></button>
				...
				<div class="col-lg-5">
					<div class="special-menu ">
						<div class="button-group filter-button-group">
							...
							<form class="" action="lunch.php" method="post">
				...
				if(isset($_POST['search']))
        {
          ...
          $display=" select * from product where Catagory_Name='Lunch' and Product_Name  like '%$searchkey%'";
        }

				else if(isset($_POST['offer']))
				{
					$display=" select * from product where Catagory_Name='Lunch' and discount!='0'";
				}

				else{
					$display=" select * from product where Catagory_Name='Lunch' ";
				}
			...
			<div class="center">
					<button class="food-btn"><a href="lunchComment.php">Feedback</a></button>
				</div>
		</div>
