...
<body>
	...
	<div class="menu-box">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Elder Healthy Diet</h2>
						<p>Eat a variety of foods from these four food groups every day:<br>

						Lean protein (lean meats, seafood, eggs, beans)<br>
						Fruits and vegetables (think orange, red, green, and purple)<br>
						Whole grains (brown rice, whole wheat pasta)<br>
						Low-fat dairy (milk and its alternatives)<br>
						<br>
						Let's see our Elder Healthy Dishes.</p><br>

						<form action="senior.php" method="post" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
				...
				<div class="col-lg-6">
					<div class="special-menu text-right">
						<div class="button-group filter-button-group">
							<button class="active" data-filter="*"><a href="senior.php" class="text-white text-bold">All</a></button>
				...
				<div class="col-lg-5">
					<div class="special-menu ">
						<div class="button-group filter-button-group">
							...
							<form class="" action="senior.php" method="post">
				...
				if(isset($_POST['search']))
        {
          ...
          $display=" select * from product where Catagory_Name='Older' and Product_Name  like '%$searchkey%'";
        }

				else if(isset($_POST['offer']))
				{
					$display=" select * from product where Catagory_Name='Older' and discount!='0'";
				}

				else{
					$display=" select * from product where Catagory_Name='Older' ";
				}
			...
			<div class="center">
					<button class="food-btn"><a href="elderComment.php">Feedback</a></button>
				</div>
		</div>
