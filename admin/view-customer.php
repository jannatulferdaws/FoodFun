...
<html lang="en">
    <head>
        ...
        <title>FoodFun - Customer Details </title>
                ...
                <main style="background-color:#cae4e9;">
                    <div class="container-fluid">
                        <div class="row ml-1" style="background-color:white;">
                            <div class="col-lg-12">
                                <h6 class="mt-1 mb-1">Home / Inventory / Customer Details</h6>
                            </div>
                        </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <a href="export-customer.php"> <button type="button" class="btn btn-info mb-4  mr-2 px-2" id="exportButton">   Export Data</button></a>
