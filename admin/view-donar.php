...
<html lang="en">
    <head>
        ...
        <title>FoodFun - Donor View</title>
                ...
                <main style="background-color:#cae4e9;">
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="row mt-4">
                            <div class="col-lg-4">
                            <a href="export-donor.php"> <button type="button" class="btn btn-info mb-4  mr-2 px-2" id="exportButton">   Export Data</button></a>
                            <a href="add-donor.php"> <button type="button" class="btn btn-warning mb-4 pr-2 px-2" id="importButton">Import Data</button></a>
                           </div>
                                    ...
                                    <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            while($row = mysqli_fetch_assoc($result)){
                                                ...
                                                <td><form class='mb-2' action='edit-donor.php' method='post'>
                                            ...
                                            if(isset($_POST['delete']))
                                            {
                                              ...
                                              $sql2="DELETE FROM `donor` WHERE `donor`.`phone` = {$_POST['cid']}";
