...
<html lang="en">
    <head>
        ...
        <title>FoodFun - Orphan View</title>
            ...
            <div id="layoutSidenav_content">
                <main style="background-color:#cae4e9;">
                    <div class="container-fluid">
                        <div class="row ml-1">
                            <div class="col-lg-12">
                               <!-- <h6 class="mt-1 mb-1">Home / Inventory / Add Products & Catagories/ <span style="color:blue;">Products</span></h6>-->
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-lg-4" >
                            <h2 class="mt-4">Orphan Details</h2>
                            </div>
                        </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="row mt-4">
                            <div class="col-lg-4">
                            <a href="export-orphan.php"> <button type="button" class="btn btn-info mb-4  mr-2 px-2" id="exportButton">   Export Data</button></a>
                            <a href="add-orphan.php"> <button type="button" class="btn btn-warning mb-4 pr-2 px-2" id="importButton">Import Data</button></a>
                           </div>
                                    ...
                                    <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            while($row = mysqli_fetch_assoc($result)){
                                                ...
                                                <td><form class='mb-2' action='edit-orphan.php' method='post'>
                                                <input type='hidden' name='cid' value=".$row['phone'].">
                                            ...
                                            if(isset($_POST['delete']))
                                            {
                                              ...
                                              $sql2="DELETE FROM `orphan` WHERE `orphan`.`phone` = {$_POST['cid']}";
