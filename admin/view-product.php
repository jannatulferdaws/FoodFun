...
<html lang="en">
    <head>
        ...
        <title>FoodFun - Product View</title>
                ...
                <main style="background-color:#cae4e9;">
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="row mt-4">
                            <div class="col-lg-4">
                            <a href="export-product.php"> <button type="button" class="btn btn-info mb-4  mr-2 px-2" id="exportButton">   Export Data</button></a>
                            <a href="add-product.php"> <button type="button" class="btn btn-warning mb-4 pr-2 px-2" id="importButton">Import Data</button></a>
                           </div>
                                        ...
                                        <tbody>
                                            ...
                                            while($row = mysqli_fetch_assoc($result)){
                                                ...
                                                ?>
                                                  ...
                                                  <td>  <img  src="<?php echo $row['Image']; ?>" alt="" class="categoryImage" ></td>
                                                ...
                                                <td><form class='mb-2' action='edit-product.php' method='post'>
                                            ...
                                            if(isset($_POST['delete']))
                                            {
                                              ...
                                              $sql2="DELETE FROM `product` WHERE `product`.`Id` = {$_POST['cid']}";
