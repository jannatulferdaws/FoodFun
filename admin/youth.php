...
<body>
	...
	<div class="menu-box">
				...
				<div class="col-lg-12">
					<div class="heading-title text-center">
						...
						* Legumes include cooked dried beans, peas and lentils..<br>
						Let's see our youth healthy Dishes.</p><br>

						<form action="youth.php" method="post" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
				...
				<div class="col-lg-6">
					<div class="special-menu text-right">
						<div class="button-group filter-button-group">
							<button class="active" data-filter="*"><a href="youth.php" class="text-white text-bold">All</a></button>
				...
				<div class="col-lg-5">
					<div class="special-menu ">
						<div class="button-group filter-button-group">
							...
							<form class="" action="youth.php" method="post">
				...
				if(isset($_POST['search']))
        {
          ...
          $display=" select * from product where Catagory_Name='Youth' and Product_Name  like '%$searchkey%'";
        }

				else if(isset($_POST['offer']))
				{
					$display=" select * from product where Catagory_Name='Youth' and discount!='0'";
				}

				else{
					$display=" select * from product where Catagory_Name='Youth' ";
				}
			...
			<div class="center">
					<button class="food-btn"><a href="#">Feedback</a></button>
				</div>
		</div>
